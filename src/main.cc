...
int main() {
  ...
  auto workItem = [&](UInt_t workerID) {
    ...
    ch->Add("/eos/cms/store/user/jingyan/LFV_Trilep_Inclusive/2016/2016_TTTo2L2Nu_UL/TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8/crab_Trilep_Inclusive_May1_BtagSF_2016_TTTo2L2Nu_UL/230501_150625/0000/tree_4.root");
    ch->Add("/eos/cms/store/user/jingyan/LFV_Trilep_Inclusive/2016/2016_TTTo2L2Nu_UL/TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8/crab_Trilep_Inclusive_May1_BtagSF_2016_TTTo2L2Nu_UL/230501_150625/0000/tree_5.root");
    ch->Add("/eos/cms/store/user/jingyan/LFV_Trilep_Inclusive/2016/2016_TTTo2L2Nu_UL/TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8/crab_Trilep_Inclusive_May1_BtagSF_2016_TTTo2L2Nu_UL/230501_150625/0000/tree_6.root");
    ch->Add("/eos/cms/store/user/jingyan/LFV_Trilep_Inclusive/2016/2016_TTTo2L2Nu_UL/TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8/crab_Trilep_Inclusive_May1_BtagSF_2016_TTTo2L2Nu_UL/230501_150625/0000/tree_7.root");
    ...
    auto workerSummary = t1.Loop(Form("test_%u.root", workerID), "mc", "TTTo2L2Nu", "2016", "", 88.4, 16.81, 125894, std::ref(progress), std::ref(counter));

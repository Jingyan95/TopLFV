...
int main(){
    ...
    // ch ->Add("/eos/cms/store/user/jingyan/LFV_Trilep_Inclusive_Apr19/2016_G_SingleElectron/SingleElectron/crab_Trilep_Inclusive_Apr24_2_2016_G_SingleElectron/230424_155919/0000/tree_4.root");

...
int main(){
    ...
    ch ->Add("/eos/cms/store/user/jingyan/LFV_Trilep_Inclusive_Apr29_JEC/2016_TTW_UL/TTWJetsToLNu_TuneCP5_13TeV-amcatnloFXFX-madspin-pythia8/crab_Trilep_Inclusive_Apr29_JEC_2016_TTW_UL/230429_193811/0000/tree_12.root");

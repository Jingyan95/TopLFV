...
int main(){
    ...
    std::atomic<Long64_t> progress(0);
    auto workItem = [=,&Summary,&progress](UInt_t workerID) {
        ...
        auto workerSummary = t1.Loop(Form("test_%u.root",workerID), "mc", "TTW", "2016", "", 0.235, 16.81, 3322643, std::ref(progress));

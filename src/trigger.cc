...
void trigger::Init(Bool_t Ele27_WPTight_Gsf,
...
Bool_t trigger::triggerLogic(TString dataset) {
  ...
  if (data_ == "mc") {
    ...
    if (year_ == "2016APV" || year_ == "2016") {
      if (Ele27_WPTight_Gsf_ && dataset_ == "SingleElectron") triggerPassE_ = true;
      if ((IsoMu24_ || IsoTkMu24_) && dataset_ == "SingleMuon") triggerPassMu_ = true;
    }
    if (year_ == "2017") {
      if (Ele35_WPTight_Gsf_ && dataset_ == "SingleElectron") triggerPassE_ = true;
      if (IsoMu27_ && dataset_ == "SingleMuon") triggerPassMu_ = true;
    }
    if (year_ == "2018") {
      if (Ele32_WPTight_Gsf_ && dataset_ == "EGamma") triggerPassE_ = true;
      if (IsoMu24_ && dataset_ == "SingleMuon") triggerPassMu_ = true;
    }
  }

...
public :
  ...
  TBranch         *b_HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL; // 2016APV, 2018
  ...
  template<class T> using Dim1 = std::vector<T>;
  template<class T> using Dim2 = std::vector<Dim1<T>>;
